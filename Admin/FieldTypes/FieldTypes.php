...
class FieldTypes {
    ...
    public function newType($alias)
    {
        ...
        throw new TypeNotFoundException(sprintf('FieldType `%s` not found. You should create a service that implements Kryn\CmsBundle\Admin\FieldTypes\TypeInterface and tag it with `kryn_cms.field.type`', $alias));
    }
