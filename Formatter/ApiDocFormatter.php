...
namespace Kryn\CmsBundle\Formatter;
...
class ApiDocFormatter extends HtmlFormatter {
    ...
    {
        return $this->engine->render('KrynCmsBundle:Admin:ApiDoc/resources.html.twig', array(
            'resources' => $collection,
            'apiName' => 'Kryn.cms REST Api Documentation',
