 ...
 *
 * Please do not handle 'permissionCheck' in $pOptions. This is handled in \Kryn\CmsBundle\Object.
...
abstract class ORMAbstract
{
    ...
    /**
     * Builds a condition for the sub-items check in \Kryn\CmsBundle\Permissions::getListingCondition() for nested set objects.
     *
     * @param Condition $condition
     *
     * @return Condition
