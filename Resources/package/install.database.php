...
namespace Kryn\CmsBundle\Package;
        ...
        array(
            '1' => array(
                ...
                array(
                    ...
                    '',
                    $defaultContentTemplate,
                    '{"bundle":"PublicationBundle","plugin":"listing","options":{"itemsPerPage":10,"maxPages":10,"detailPage":"","template":"default.tpl","categoryId":[],"enableRss":false}}'
                )
            ),
            '2' => array(
                array(
                    ...
                    '» CATEGORIES',
                    $defaultContentTemplate,
                    '{"bundle":"PublicationBundle","plugin":"categoryList","options":{"listNode":"1","template":"default.tpl","category_rsn":[]}}'
                ),
            )
        ),
        array(
