ka.AdminInterface = new Class({
    ...
    hideAppContainer: function() {
        if (Modernizr.csstransforms && Modernizr.csstransitions) {
            ka.adminInterface.getAppContainer().setStyle(Modernizr.prefixed('transform'), 'translate(0px, 100%)');
        } else {
    ...
    showAppContainer: function() {
        if (Modernizr.csstransforms && Modernizr.csstransitions) {
            ka.adminInterface.getAppContainer().setStyle(Modernizr.prefixed('transform'), 'translate(0px, 0px)');
        } else {
    ...
    createLayout: function() {
        ...
        new Element('img', {
            'class': 'ka-main-menu-start',
            src: _path + 'bundles/kryncms/admin/images/kryn-icon.png'
        })
        ...
        this.mainMenuTopLogo = new Element('img', {
            ...
            src: _path + 'bundles/kryncms/admin/images/logo-without-icon.png'
        }).inject(this.mainMenuTop);
...
//                src: 'bundles/kryncms/admin/images/icon-search-loupe.png'
...
//        }
    ...
    doMiniSearch: function() {
        ...
        if (!this._miniSearchPane) {
            ...
            this._miniSearchResults =
                new Element('div', {'class': 'ka-mini-search-results'}).inject(this._miniSearchPane);
    ...
    renderLogin: function() {
        ...
        new Element('img', {
            'class': 'ka-login-logo',
            src: _path + 'bundles/kryncms/admin/images/logo.png'
...
//    },
        ...
        if (1 == entryPoint.level) {
            ...
            if (parent) {
                ...
                if (!parent.hasClass('ka-menu-item-hasChilds')) {
                    ...
                    new Element('img', {
                        src: _path + 'bundles/kryncms/admin/images/ka-mainmenu-item-tree_minus.png'
                    }).inject(childOpener);
    ...
    openSearchContext: function() {
        ...
        new Element('img', {
            ...
            src: _path + 'bundles/kryncms/admin/images/ka-tooltip-corner-top.png'
