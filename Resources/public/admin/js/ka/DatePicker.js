ka.DatePicker = new Class({
    ...
    _renderChooser: function() {
        ...
        if (this.options.time == true) {
            ...
            this.timeHours = new Element('input', {'class': 'ka-datePicker-timeHours'}).addEvent('keydown', function(e) {
            ...
            this.timeMinutes = new Element('input', {'class': 'ka-datePicker-timeMinutes'}).addEvent('keydown', function(e) {
                    this.setTimes.call(this, e)
                }.bind(this)).addEvent('keyup', function(e) {
                    this.setTimes.call(this, e)
                }.bind(this)).inject(this.time);
