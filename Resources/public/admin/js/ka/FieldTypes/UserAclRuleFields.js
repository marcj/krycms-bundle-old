ka.FieldTypes.UserAclRuleFields = new Class({
    ...
    renderFields: function () {
        ...
        Object.each(definition.fields, function (def, key) {
            ...
            select.add('2', [t('Inherited'), 'bundles/kryncms/admin/images/icons/arrow_turn_right_up.png']);
            select.add('0', [t('Deny'), 'bundles/kryncms/admin/images/icons/exclamation.png']);
            select.add('1', [t('Allow'), 'bundles/kryncms/admin/images/icons/accept.png']);
    ...
    createConditionRule: function (pDefinition, pKey) {
        ...
        var conditions = new Element('div', {
            'class': 'ka-user-acl-rule-field-item-detail-rule-conditions',
            style: 'padding-left: 15px;'
        }).inject(div);

        new ka.Button([t('Add field rule'), 'bundles/kryncms/admin/images/icons/add.png'])
    ...
    checkHasFieldRules: function (pFieldKey) {
        ...
        if (this.rows[pFieldKey].getElement('.ka-user-acl-rule-fields-item')) {
    ...
    addFieldRule: function (pContainer, pFieldKey, pValues) {
        ...
        var div = new Element('div', {
            'class': 'ka-user-acl-rule-fields-item'
        });
        ...
        document.id(conditionField).addClass('ka-user-acl-rule-fields-item-conditionfield');
    ...
    getValue: function () {
        ...
        Object.each(this.rows, function (tr, key) {
            ...
            var conditions = this.rows[key].getElement('.ka-user-acl-rule-field-item-detail-rule-conditions');

            if (conditions.getElement('.ka-user-acl-rule-fields-item')) {
