ka.WindowCombine = new Class({
    ...
    renderLayout: function() {
        ...
        this.mainLeft = new Element('div', {
            'class': 'ka-WindowList-combine-left'
        ...
        this.mainRight.addClass('ka-WindowList-combine-right');
        ...
        if (this.classProperties.asNested) {
            ...
            this.mainLeftTop = new Element('div', {
                'class': 'ka-WindowList-combine-left-top'
            }).inject(this.mainLeft, 'top');
            ...
            this.itemCount = new Element('div', {
                'class': 'ka-WindowList-combine-left-itemcount'
            }).inject(this.mainLeftTop);
            ...
            this.removeCombineSelectedBtn = new ka.Button(t('Remove selected')).addEvent('click', this.removeCombineSelected.bind(this)).inject(this.mainLeftDeleter);
    ...
    renderSideActionBar: function() {
        ...
        this.editAddSidebarContainer = new Element('div', {
            'class': 'ka-WindowList-combine-sidebarContainer'
        ...
        if (this.currentViewType !== viewType) {
            ...
            if ('list' === viewType) {
                ...
                if (Modernizr.csstransforms && Modernizr.csstransitions) {
                    this.container.addClass('ka-windowCombine-list-show');
                    this.combineContainer.removeClass('ka-windowCombine-combine-show');
                } else {
                ...
                if (Modernizr.csstransforms && Modernizr.csstransitions) {
                    this.container.removeClass('ka-windowCombine-list-show');
                    this.combineContainer.addClass('ka-windowCombine-combine-show');
                } else {
    ...
    renderSearchPane: function() {
        this.searchIcon = new Element('div', {
            'class': 'ka-WindowList-combine-searchicon icon-search-8',
            style: 'display: none'
    ...
    prevItemLoaderStart: function() {
        ...
        this.prevItemLoader.set('html', '<img src="' + _path + 'bundles/kryncms/admin/images/loading.gif" />' + '<br />' + _('Loading entries ...'));
    },
    ...
    toggleSearch: function() {
        ...
        if (!this.searchOpened) {
            this.searchEnable = 1;
            this.searchIcon.addClass('ka-WindowList-combine-searchicon-active');
            ...
            this.searchEnable = 0;
            this.searchIcon.removeClass('ka-WindowList-combine-searchicon-active');
    ...
    getSplitTitle: function(pItem) {
        ...
        var value = ka.getObjectFieldLabel(pItem, this.classProperties.columns[this.sortCombineField], this.sortCombineField, this.classProperties['object']);
        if (value == '') {
            return _('-- No value --');
        }
    ...
    loadRootItem: function(pItem, objectKey) {
        ...
        if (!this.currentRootEdit) {
            ...
            win.entryPoint = ka.entrypoint.getRelative(this.win.entryPoint, this.classProperties.nestedRootEditEntrypoint);
    ...
    loadAround: function(pPrimary) {
        ...
        this.order = {};
        this.order[this.sortCombineField] = this.sortCombineDirection;
        var id = ka.getCroppedObjectId(pPrimary);
    ...
    addCombineItem: function(pItem) {
        ...
        //parse template
        var data = ka.getObjectLabels(this.classProperties.columns, pItem, this.classProperties['object'], true);
        ...
        if (this.needSelection) {
            if (this.win.params.selected == pk) {
                ...
                item.addClass('active');
                this.loadItem(pItem, ka.normalizeObjectKey(this.classProperties['object']));
            }
        }
