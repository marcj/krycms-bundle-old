var kryncms_system_development_logs = new Class({
    ...
    _renderLayout: function() {
        ...
        this.logRequestsTable = new ka.Table().inject(this.logRequestsTableContainer);
...
//            }.bind(this)).inject(dialog.getContentContainer());
        ...
        this.logsTable = new ka.Table().inject(this.logsTableContainer);
