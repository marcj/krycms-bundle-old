var kryncms_system_module = new Class({
    ...
    renderLocal: function (pMods) {
        ...
        var createBtn = buttonBar.addButton(_('Create Bundle'), function () {
            ...
            prompt.packageInput = new ka.Field({
            ...
            prompt.classInput = new ka.Field({
            ...
            prompt.className = new ka.Field({
                type: 'info',
                label: t('Generates bundle class name:'),
                value: '(autogenerated)'
            }, prompt.getContentContainer());

            prompt.fileName = new ka.Field({
                type: 'info',
                label: t('Generates php file:'),
                value: '(autogenerated)'
            }, prompt.getContentContainer());

            prompt.composer = new ka.Field({
                type: 'info',
                label: t('Your composer.json path:'),
                value: '(autogenerated)'
            }, prompt.getContentContainer());

            prompt.directoryStructure = new ka.Field({
        ...
        Object.each(pMods, function (mod, key) {
            ...
            if (!['Kryn\CmsBundle\KrynCmsBundle'].contains(key)) {
                if (item.activated) {
                    ...
                    var activate =  new ka.Button(_('Activate'))
...
//            html: '<center><img src="' + _path + 'bundles/kryncms/admin/images/loading.gif" /></center>'
//        }).inject(this.mainPane);
//
//        new Request.JSON({url: _pathAdmin +
