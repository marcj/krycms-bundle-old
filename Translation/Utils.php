...
class Utils extends Controller
{
    ...
    public function getPluralForm($lang, $onlyAlgorithm = false)
    {
        ...
        $file = $this->getKrynCore()->resolvePath('@KrynCmsBundle/Resources/package/gettext-plural-forms.csv');
        if (!file_exists($file)) {
            return false;
        }
    ...
    {
        $file = $this->getKrynCore()->resolvePath("@$bundle/$lang.po", 'Resources/translations');
...
"Plural-Forms: ' . $pluralForms . '\n"' . "\n\n"
    ...
    public function extractLanguage($bundleName)
    {
        ...
        $bundleDir = $this->getKrynCore()->getBundleDir($bundleName);
...
//
//            //->tc("context", "translation")
//            '/->tc\(\s*"(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*\)/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1]."\004".$p[4])] = true',
//
//            //->t("singular", "plural", $count, "context"
//            '/->t\(\s*"(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*,[^,]*,\s*"(((\\\\.)|[^"])*)"\s*\)/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[7]."\004".$p[1])] = array($p[1], $p[4])',
//
//            //->t('singular', 'plural', *, 'context'
//            "/->t\(\s*'(((\\\\.)|[^'])*)'\s*,\s*'(((\\\\.)|[^'])*)'\s*,[^,]*,\s*'(((\\\\.)|[^'])*)'\s*\)/" => '[$p[7]."\004".$p[1]] = array($p[1], $p[4])',
//
//            //->t("singular", "plural", $count)
//            '/->t\(\s*"(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*,[^\)]*\)/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1])] = array($p[1], $p[4])',
//
//            //->t('singular', 'plural', $count)
//            "/->t\(\s*'(((\\\\.)|[^'])*)'\s*,\s*'(((\\\\.)|[^'])*)'\s*,[^\)]*\)/" => '[$p[1]] = array($p[1], $p[4])',
//
            //{{ t("singular", "plural", $count) }}
            '/\{\{\s*t\s*\("(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*,\s*[^\}"]*\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1])] = array($p[1], $p[4])',
            '/\{\{\s*t\s*\(\'(((\\\\.)|[^\'])*)\'\s*,\s*\'(((\\\\.)|[^\'])*)\'\s*,\s*[^\}\']*\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1])] = array($p[1], $p[4])',

            //{{ tc("context", "singular", "plural", $count) }}
            '/\{\{\s*tc\s*\("(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*,\s*[^\}"]*\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1]."\004".$p[4])] = array($p[4], $p[7])',
            '/\{\{\s*tc\s*\(\'(((\\\\.)|[^\'])*)\'\s*,\s*\'(((\\\\.)|[^\'])*)\'\s*,\s*\'(((\\\\.)|[^\'])*)\'\s*,\s*[^\}\']*\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1]."\004".$p[4])] = array($p[4], $p[7])',

            //{{ tc("context", "translation") }}
            '/\{\{\s*tc\s*\(\s*"(((\\\\.)|[^"])*)"\s*,\s*"(((\\\\.)|[^"])*)"\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1]."\004".$p[4])] = true',
            '/\{\{\s*tc\s*\(\s*\'(((\\\\.)|[^\'])*)\'\s*,\s*\'(((\\\\.)|[^\'])*)\'\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1]."\004".$p[4])] = true',

            //{{ t("context") }}
            '/\{\{\s*t\s*\(\s*"(((\\\\.)|[^"])*)"\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1])] = true',
            '/\{\{\s*t\s*\(\s*\'(((\\\\.)|[^\'])*)\'\s*\)\s*\}\}/' => '[\Kryn\CmsBundle\Translation\Utils::evalString($p[1])] = true',
        );
